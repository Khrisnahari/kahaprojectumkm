    ...
    <div class="card-body">
        <form action="{{ route('umkm.update', $umkm->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mt-3">
                ...
                <input type="nama_umkm" class="form-control" id="nama_umkm" name="nama_umkm" value="{{ old('nama_umkm', $umkm->nama_umkm) }}">
            ...
            <div class="mt-3">
                ...
                <input type="alamat" class="form-control" id="alamat" name="alamat" value="{{ old('alamat', $umkm->alamat) }}">
